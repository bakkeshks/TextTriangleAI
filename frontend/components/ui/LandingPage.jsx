  ...
  <section id="highlights" className="bg-gray-50 py-16 md:py-24">
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        />
        <HighlightItem
          title="Versatile Video Support"
          description="Easily convert YouTube videos, Shorts, local videos, and audio into detailed technical blog posts."
          icon={Film}
        />
        <HighlightItem
        ...
        <HighlightItem
          ...
          description="Support for various video and audio formats, catering to diverse content needs."
          icon={FileText}
        />
        <HighlightItem
